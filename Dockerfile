...
# /iguana/
#        /config        Workaround folder, which contains only the config_test.xml (must be overriden
#                       by user when he uses "docker run")
...
# config folder must only contain config_test.xml and queries.txt
ADD config_test.xml /iguana/config_test.xml
ADD queries.txt /iguana/queries.txt

# will contain all required jar files
